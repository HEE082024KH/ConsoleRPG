...
public class AbilitiesList
{
  ...
  [
    ...
    new("Scorch", "A burst of fire.", "Fire", 12, 30, 10, 100),
    ...
    new("Flame cannon", "Shoots a volley of fire and lava.", "Fire", 41, 15, 40, 90),
    new("Fire Blast", "Blasts the target with blazing fire.", "Fire", 46, 10, 45, 100),
    new("Fire Wall", "Conjures a wall of fire protecting the user.", "Fire", 47, 10, 50, 95),
    new("Blaze Tornado", "Hurls a tornado of scorching hot fire.", "Fire", 50, 10, 50, 95),
    new("Molten Eruption", "An eruption of molten lava exploding with velocity.", "Fire", 57, 5, 60, 85),
    new("Inferno", "Fire surrounds the user as a blast wave erupts.", "Fire", 65, 5, 80, 100),

    // Frost
    new("Rime", "", "Frost", 5, 35, 5, 100),
    new("", "", "Frost", 11, 0, 0, 0),
    new("Frostbolt", "Shoots a projectile of frost and cold", "Frost", 15, 20, 15, 100),
    new("Chill", "Chills the target, increasing Frost damage taken", "Frost", 19, 20, 2, 95),
    new("", "", "Frost", 29, 0, 0, 0),
    new("", "", "Frost", 32, 0, 0, 0),
    new("", "", "Frost", 39, 0, 0, 0),
    new("", "", "Frost", 45, 0, 0, 0),
